...
resource "azurerm_policy_assignment" "deny_kv_public" {
...
resource "azurerm_policy_assignment" "deny_aks_privileged" {
...
resource "azurerm_policy_assignment" "audit_sql_aad" {
